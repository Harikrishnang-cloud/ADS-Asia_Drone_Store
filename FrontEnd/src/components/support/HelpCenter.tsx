        ...
        <div className="min-h-screen">
            ...
            <section className="bg-white py-6 md:py-10">
                <div className="container mx-auto px-6 text-center">
                    <h2 className="text-xl md:text-5xl font-black text-brand-blue-dark mb-3 md:mb-6">Still need assistance?</h2>
                    <p className="text-slate-500 text-xs md:text-lg mb-8 md:mb-16 max-w-2xl mx-auto font-medium">
